Aqui está o código adaptado para um modelo NBH em Ruby:
...
Esse código define uma classe `GFp` dentro do módulo `NBH`, com métodos correspondentes às funções do pacote `bn256` em Go.